  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          Open for{' '}
          <span className="bg-gradient-to-r from-[#ff8ae2] via-[#ec4899] to-[#ff8ae2] bg-clip-text text-transparent">
            Contributions
          </span>
        </motion.h2>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 bg-gradient-to-r from-[#ff8ae2] via-[#ec4899] to-[#9c4668] text-white font-bold text-lg px-8 py-4 rounded-full shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 transition-shadow"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 bg-[#ff8ae2] rounded-full animate-pulse"></span>
